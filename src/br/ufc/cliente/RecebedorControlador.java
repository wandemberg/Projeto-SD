	...
	public void run() {
		...
		while (!terminar) {
			...
			if (msgControlador.getTipoObjeto().equals("Arcondicionado")) {			
				...
				System.out.println("Status Arcondicionado recebida do Servidor e atualizada, est· ligada: " + ((Arcondicionado)msgControlador.getObj()).isLigar());
				...
				System.out.println("Status Cortina recebida do Servidor e atualizada, est· ligada: " + ((Cortina)msgControlador.getObj()).isLevantar());

			} else if (msgControlador.getTipoObjeto().equals("Tv")) {
				cliente.getListaDispositivos().replace("Tv", (Tv)msgControlador.getObj());
				System.out.println("Status Tv recebida do Servidor e atualizada, est· ligada: " + ((Tv)msgControlador.getObj()).isLigar());

			} else if (msgControlador.getTipoObjeto().equals("Radio")) {
				cliente.getListaDispositivos().replace("Radio", (Radio)msgControlador.getObj());
				System.out.println("Status Radio recebida do Servidor e atualizada, est· ligada: " + ((Radio)msgControlador.getObj()).isLigar());
